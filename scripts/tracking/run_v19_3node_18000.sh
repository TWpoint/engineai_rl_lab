...
v19_load_run="2026-08-23_19-44-59_v19-scale"
v19_checkpoint="model_18000.pt"
...
v19_log="${v19_project_dir}/v19_scale_resume_18000_3node_${v19_num_envs}_${v19_node_name}.log"
...
runtime_cfg = T800FlatWoStateEstimationEnvCfgV19Scale()
assert runtime_cfg.commands.motion.curriculum_sampling_strategy == "learnability"
assert runtime_cfg.rewards.joint_acc_l2 is None
assert MotionCommand._CURRICULUM_LEARNABILITY_SCHEMA_VERSION == 9
...
assert int(adaptive["curriculum_state_schema_version"].item()) == 8
...
print("[preflight] Current V19 schema-9 and V19/model_18000 schema-8 checkpoint are correct.")
PY

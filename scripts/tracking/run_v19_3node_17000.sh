...
v19_log="${v19_project_dir}/v19_scale_resume_17000_3node_${v19_num_envs}_${v19_node_name}.log"
...
assert int(checkpoint["iter"]) == 17000
assert int(adaptive["curriculum_state_schema_version"].item()) == 7
print("[preflight] V19 registration and V18/model_17000 schema-7 checkpoint are correct.")
PY
